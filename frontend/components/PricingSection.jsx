        ...
        <Card className="border-2 border-stone-200 bg-white">
          ...
          <CardFooter className={"mt-auto"}>
            <Link href="/dashboard" className="w-full">
              <Button
                variant="outline"
                className="w-full border-2 border-stone-500 hover:bg-stone-900 cursor-pointer"
              >
                Get Started
              </Button> 
            </Link>
        ...
        <Card className="relative border-2 border-orange-600 bg-orange-50">
          ...
          <CardFooter>
            <SignedIn>
              ...
              >
                <Button
                  ...
                  className="w-full bg-orange-600 hover:bg-orange-700 disabled:bg-orange-400 disabled:cursor-not-allowed text-white cursor-pointer"
                >
            ...
            <SignedOut>
              ...
              <Button variant="primary" className="w-full bg-orange-600 hover:bg-orange-700 text-white curspo cursor-pointer">
                  Login to Subscribe
                </Button>
              </SignInButton>
            </SignedOut>
