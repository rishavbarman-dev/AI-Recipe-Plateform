...
import { AlertCircle, ArrowLeft, Badge, Bookmark, BookmarkCheck, CheckCircle2, ChefHat, Clock, Download, Flame, Lightbulb, Loader2, Users } from "lucide-react";
...
function RecipeContent() {
  ...
  const recipeName = serachParams.get("cook");
    ...
    return (
      <div className="min-h-screen bg-stone-50 pt-24 pb-16">
        <div className="container mx-auto max-w-4xl text-center py-20">
          <div
            className="bg-orange-50 w-20 h-20 border-2 border-orange-200 flex
        ...
        <p className="text-stone-600 mb-6 font-light">
          Please selcect a recipe from the dashboard
        </p>
        <Link href="/dashboard">
     ...
     <div className="min-h-screen bg-stone-50 pt-24 pb-16">
      <div className="container mx-auto max-w-4xl text-center py-20">
        ...
        <p className="text-stone-600 font-light">
            Our Ai chefs are cooking up a storm to bring you the best version of <span className="font-bold text-orange-600">{recipeName}</span>. This might take a moment, but we promise it'll be worth the wait!
        </p>
      </div>
    </div>
   )
